...
const README_URL =
  "https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/refs/heads/master/rule/Clash/README.md";
...
export async function GET() {
  ...
  if (!markdown) {
    return NextResponse.json({ error: "无法获取Markdown文件且本地缓存不可用" }, { status: 500 });
  }
